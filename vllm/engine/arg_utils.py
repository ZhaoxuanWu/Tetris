...
class EngineArgs:
    ...
    def add_cli_args(parser: FlexibleArgumentParser) -> FlexibleArgumentParser:
        ...
        parser.add_argument('--is-parallel', action='store_true')
    ...
    def create_engine_config(self) -> VllmConfig:
        ...
        speculative_config = SpeculativeConfig.maybe_create_spec_config(
            ...
            dsd = self.dsd,
            tetris=self.tetris,
            tetris_extra_proposals=self.tetris_extra_proposals,
            tetris_turn_on_batch_size=self.tetris_turn_on_batch_size,
