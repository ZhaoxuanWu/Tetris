...
class LLMEngine:
    ...
    def _process_model_outputs(self,
        ...
        for i in indices:
            ...
            # PARALLEL: for parallel implementation, half of the time
            # the requests are not processed (contains -1 tokens as 
            # the first token). Skip such requests.
            if output[0].samples[0].output_token == -1:
                continue
