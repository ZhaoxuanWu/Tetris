...
class Metrics:
    ...
    def __init__(self, labelnames: List[str], max_model_len: int):
        ...
        self.counter_spec_decode_num_accepted_tokens = (self._counter_cls(
            ...
            labelnames=labelnames))
        self.gauge_spec_decode_good_draft_rate = self._gauge_cls(
            name="vllm:spec_decode_good_draft_rate",
            documentation="Number of good draft tokens until first rejection divided by all drafts.",
            labelnames=labelnames,
            multiprocess_mode="sum")
...
class LoggingStatLogger(StatLoggerBase):
    ...
    def __init__(self, local_interval):
    ...
    def handle_signal(self, signum, frame):
        self.save_spec_decode_metrics()

    def save_spec_decode_metrics(self):
        # save spec decode metrics to file (if file not exists, create it)
        with open("./bench_results/spec_decode_metrics.txt", "a") as f:
            f.write(f"{self.last_log_content}\n")
    ...
    def log(self, stats: Stats) -> None:
        ...
        if local_interval_elapsed(stats.now, self.last_local_log,
            ...
            if self.spec_decode_metrics is not None:
                ...
                self.last_log_content = self._format_spec_decode_metrics_str(self.spec_decode_metrics)
    ...
    def _format_spec_decode_metrics_str(
        ...
        return ("Speculative metrics: "
                ...
                f"Good draft rate: {metrics.good_draft_rate:.3f}, "
    ...
    def log(self, stats: Stats):
        ...
        if local_interval_elapsed(stats.now, self.last_local_log,
            ...
            if self.spec_decode_metrics is not None:
                ...
                self._log_gauge(
                    self.metrics.gauge_spec_decode_good_draft_rate,
                    self.spec_decode_metrics.good_draft_rate)
