...
class RejectionSampler(SpecDecodeStochasticBaseSampler):
    ...
    def forward(
        ...
        proposal_lens_list: Optional[List[int]] = None,
        ...
        if self.use_flashinfer:
            ...
            # with varlen, the bonus token is no longer always the last
            if proposal_lens_list is not None:
                ...
                bonus_mask[torch.arange(batch_size), proposal_lens_list, :] = 1
            ...
            if proposal_lens_list is not None:
                extra_kwargs["proposal_lens_list"] = proposal_lens_list
