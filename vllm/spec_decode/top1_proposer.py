...
class Top1Proposer(SpeculativeProposer):
    ...
    def _merge_outputs(
        ...
        proposal_tokens, proposal_probs, sampled_token_logprobs, *_ = sampler_output_to_torch(
        ...
        entire_proposal_logprobs = sampled_token_logprobs.new_zeros(
            batch_size,
            *sampled_token_logprobs.shape[1:],
        )
        entire_proposal_logprobs[nonzero_proposal_len_indices] = sampled_token_logprobs
